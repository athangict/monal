...
class ContractorAwardTable extends AbstractTableGateway 
{
	protected $table = 'rs_contractor_award'; //tablename
	...
	{  
	    ...
	    $select->from(array('c' => $this->table))
				->join(array('p' => 'fa_party'),'p.id=c.contractor',array('contractor_name'=>'name'))
				->order('id DESC');
