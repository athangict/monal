...
class TransporterInvoiceTable extends AbstractTableGateway 
{
	protected $table = 'st_transporter_invoice';   //tablename
	...
	{	
		...
		$select->from($this->table)
                 ->columns(array(
					'id','transport_inv_no','transport_inv_date','location','from_date','to_date',
					'transporter','total_amount','deduction','payable_amount','status','author','created','modified',
