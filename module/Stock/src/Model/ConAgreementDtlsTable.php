...
class ConAgreementDtlsTable extends AbstractTableGateway 
{
	protected $table = 'st_con_agreement_dtls'; //contractor agreement details tablename
	...
	public function get($param)
	{
		...
		$select->from(array('ad'=>$this->table))
				->join(array('w'=>'pur_work_type'),'w.id = ad.work_type',array('work_type' => 'work_type','work_type_id' => 'id'))
				->join(array('c'=>'st_charges_tax'),'c.id = ad.charge',array('charge' => 'value','charge_tax_id' => 'id'))
		       ->where($where);
