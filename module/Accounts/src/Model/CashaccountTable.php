...
class CashaccountTable extends AbstractTableGateway 
{
	protected $table = 'fa_cash_account'; //tablename
	...
	{
		$where = ( is_array($param) )? $param: array('ca.id' => $param);
		$adapter = $this->adapter;
		$sql = new Sql($adapter);
		$select = $sql->select();
		$select->from(array('ca'=>$this->table))
	...
	/**
	 * get cash account based on location
	 * @param Int $id
	 * @return Array
	 */
	...
	*/
	 ...
	 * @return Array
	 */
	public function getcashaccount($param)
	{   
