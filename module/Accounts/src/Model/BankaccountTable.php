...
class BankaccountTable extends AbstractTableGateway 
{
	protected $table = 'fa_bank_account'; //tablename
	...
	{  
	    ...
	    $select->from(array('ba'=>$this->table))
				->join(array('l'=>'adm_location'), 'l.id=ba.location', array('location'=>'location',  'location_id'=>'id'))
