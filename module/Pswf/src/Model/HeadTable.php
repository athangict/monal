...
class HeadTable extends AbstractTableGateway 
{
	protected $table = 'ps_head'; //tablename
	...
	/**
	 * Return All records of table- WITHOUT JOIN
	 * @return Array
	 */
	 ...
	 * @return Array
	 */
	public function getTypeBank($param)
	{
		$where = ( is_array($param) )? $param: array('h.id' => $param);
		$adapter = $this->adapter;
		$sql = new Sql($adapter);
