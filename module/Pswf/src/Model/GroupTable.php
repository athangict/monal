...
{
	protected $table = 'ps_group'; //tablename
...
/**
	...
	*/
	 ...
	 * 
	 **/
	public function getTransactionGroupforPLS($activity,$region,$location,$start_date,$end_date, $where)
	{
	 ...
	 * 
	 **/
	public function getTransactionGroupforBS($activity,$region,$location,$start_date,$end_date, $where)
	{
	 ...
	 * 
	 **/
	public function getTransactionGroup($activity,$region,$location,$start_date,$end_date, $where)
	{
		//extract($options);
