...
{   
	...
	public function indexAction()
	{
		...
		return new ViewModel(array(
			...
			'classes' => $this->getDefinedTable(Pswf\ClassTable::class)->getAll(),
	...
	{
		$this->init();
		$classTable = $this->getDefinedTable(Pswf\ClassTable::class)->getAll();
	...
	public function addclassAction()
	{
		...
		if($this->getRequest()->isPost()){
			...
			$result = $this->getDefinedTable(Pswf\ClassTable::class)->save($data);
			...
			return $this->redirect()->toRoute('pchartaccount', array('action'=>'class'));
		}
	...
	public function editclassAction()
	{
		...
		if($this->getRequest()->isPost())
		{
			...
			return $this->redirect()->toRoute('pchartaccount');
		}
		$ViewModel = new ViewModel(array(
			'class' => $this->getDefinedTable(Pswf\ClassTable::class)->get($class_id),
		));
		$ViewModel->setTerminal(True);
		return $ViewModel;
	}
	...
	{
		$this->init();
		$groupTable = $this->getDefinedTable(Pswf\GroupTable::class)->getAll();
	...
	public function addgroupAction()
	{
		...
		if($this->getRequest()->isPost()){
			...
			$data = $this->_safedataObj->rteSafe($data);
			$result = $this->getDefinedTable(Pswf\GroupTable::class)->save($data);
			if($result > 0):
			...
			return $this->redirect()->toRoute('pchartaccount', array('action'=>'group'));
		}
		$ViewModel = new ViewModel(array(
			'class' => $this->getDefinedTable(Pswf\ClassTable::class)->getAll(),
		));
		$ViewModel->setTerminal(True);
		return $ViewModel;
	}
	...
	public function editgroupAction()
	{
		...
		$ViewModel = new ViewModel(array(
			'group' => $this->getDefinedTable(Pswf\GroupTable::class)->get($this->_id),
			'class' => $this->getDefinedTable(Pswf\ClassTable::class)->getAll(),
		));
		$ViewModel->setTerminal(True);
		return $ViewModel;
	...
	{
		$this->init();
		$headtypeTable = $this->getDefinedTable(Pswf\HeadtypeTable::class)->getAll();
	...
	public function addheadtypeAction()
	{
		...
		if($this->getRequest()->isPost()){
			...
			$data = $this->_safedataObj->rteSafe($data);
			$result = $this->getDefinedTable(Pswf\HeadtypeTable::class)->save($data);
			...
			return $this->redirect()->toRoute('pchartaccount', array('action'=>'headtype'));
		}
		$ViewModel = new ViewModel(array(
	...
	public function editheadtypeAction()
	{
		...
		$ViewModel = new ViewModel(array(
			'headtype' => $this->getDefinedTable(Pswf\HeadtypeTable::class)->get($this->_id),
		));
		$ViewModel->setTerminal(True);
		return $ViewModel;
	}
	...
	{
		$this->init();
		$headTable = $this->getDefinedTable(Pswf\HeadTable::class)->getAll();
		//print_r($headTable);exit;
	...
	public function addheadAction()
	{
		...
		if($this->getRequest()->isPost()){
			...
			$data = $this->_safedataObj->rteSafe($data);
			$result = $this->getDefinedTable(Pswf\HeadTable::class)->save($data);
			if($result > 0):
			...
			return $this->redirect()->toRoute('pchartaccount', array('action'=>'head'));
		}
		$ViewModel = new ViewModel(array(
			'group' => $this->getDefinedTable(Pswf\GroupTable::class)->getAll(),
	...
	public function editheadAction()
	{
		...
		$ViewModel = new ViewModel(array(
			'head' => $this->getDefinedTable(Pswf\HeadTable::class)->gethead($this->_id),
			'group' => $this->getDefinedTable(Pswf\GroupTable::class)->getAll(),
			'headtype' => $this->getDefinedTable(Pswf\HeadtypeTable::class)->getAll(),
		));
		$ViewModel->setTerminal(True);
	...
	{
		$this->init();
		$partyroleTable = $this->getDefinedTable(Pswf\PartyroleTable::class)->getAll();
	...
	public function addpartyroleAction()
	{
		...
		if($this->getRequest()->isPost()){
			...
			$data = $this->_safedataObj->rteSafe($data);
			$result = $this->getDefinedTable(Pswf\PartyroleTable::class)->save($data);
			...
			return $this->redirect()->toRoute('pchartaccount', array('action'=>'partyrole'));
		}
		$ViewModel = new ViewModel(array(
		));
		$ViewModel->setTerminal(True);
	...
	public function editpartyroleAction()
	{
		...
		$ViewModel = new ViewModel(array(
			'partyrole' => $this->getDefinedTable(Pswf\PartyroleTable::class)->get($this->_id),
		));
		$ViewModel->setTerminal(True);
		return $ViewModel;
	} 
	...
	public function subheadAction()
	{
		...
		$subheadTable = $this->getDefinedTable(Pswf\SubheadTable::class)->getSubhead($data);
		...
		//$subheads = $this->getDefinedTable(Pswf\SubheadTable::class)->getSubhead($data);
		return new ViewModel(array(
			'title'       => 'SubHead',
			'data'        => $data,
			'paginator'   => $paginator,
	...
	**/
	public function getgroupAction()
	{
		...
		$class_id = $form['class'];
		$groups = $this->getDefinedTable(Pswf\GroupTable::class)->get(array('class' => $class_id));
	...
	**/
	public function getheadAction()
	{
		...
		$heads = $this->getDefinedTable(Pswf\HeadTable::class)->get(array('group' => $group_id));
	...
	{ //echo'hellow';exit;
		...
		if($this->getRequest()->isPost()){
			$form = $this->getRequest()->getPost();
				...
				//echo '<pre>';print_r($data);exit;
				$data = $this->_safedataObj->rteSafe($data);
				$result = $this->getDefinedTable(Pswf\SubheadTable::class)->save($data);
			...
			//endif;			
		return $this->redirect()->toRoute('pchartaccount', array('action'=>'subhead'));
		}
		$ViewModel = new ViewModel(array(
			'headtype' => $this->getDefinedTable(Pswf\HeadtypeTable::class)->getAll(),
			'head'	=> $this->getDefinedTable(Pswf\HeadTable::class)->getAll(),
		));
		$ViewModel->setTerminal(True);
		return $ViewModel;
	}
	...
	public function editsubheadAction()
	{
		...
		$ViewModel = new ViewModel(array(
			'title' => 'Edit Subhead',
			'headtype' => $this->getDefinedTable(Pswf\HeadtypeTable::class)->getAll(),
			'subhead' => $this->getDefinedTable(Pswf\SubheadTable::class)->get($this->_id),
			'headObj' =>$this->getDefinedTable(Pswf\HeadTable::class),
			...
			'cashaccounts' => $this->getDefinedTable(Pswf\CashaccountTable::class)->getAll(),
	...
	public function getCodeNameAction()
	{
		...
		switch ($type){
			case 1: // Sub Head for Assets
				    $codeAlls = $this->getDefinedTable(Pswf\AssetsTable::class)->getAll();
				    foreach($codeAlls as $codeAll):
						$code .="<option value='".$codeAll['id']."'>".$codeAll['code']."</option>";
					endforeach;
					break;
			case 2: // Sub Head for Party
				    $codeAlls = $this->getDefinedTable(Pswf\PartyTable::class)->getAll();
				    foreach($codeAlls as $codeAll):
						$code .="<option value='".$codeAll['id']."'>".$codeAll['code']."</option>";
					endforeach;
					break;
			case 3: // Sub Head for Bank Accounts
				    $codeAlls = $this->getDefinedTable(Pswf\BankaccountTable::class)->getAll();
				    foreach($codeAlls as $codeAll):
						$code .="<option value='".$codeAll['id']."'>".$codeAll['code']."</option>";
					endforeach;
					break;
			case 4: // Sub Head for Fund
			      	$codeAlls = $this->getDefinedTable(Pswf\FundTable::class)->getAll();
				    foreach($codeAlls as $codeAll):
						$code .="<option value='".$codeAll['id']."'>".$codeAll['code']."</option>";
					endforeach;
					break;
			...
			case 6: // Sub Head for Cash Accounts
				    $codeAlls = $this->getDefinedTable(Pswf\CashaccountTable::class)->getAll();
				    foreach($codeAlls as $codeAll):
						$code .="<option value='".$codeAll['id']."'>".$codeAll['cash_account']."</option>";
					endforeach;
					break;
			case 7: // Sub Head for Income Head
				    $codeAlls = $this->getDefinedTable(Pswf\IncomeheadTable::class)->getAll();
				    foreach($codeAlls as $codeAll):
	...
	public function getSHCodeNameAction()
	{
		...
		switch ($type){
			case 1: // Sub Head for Assets
				    $shcode = $this->getDefinedTable(Pswf\AssetsTable::class)->getColumn($subheadID, 'code');
				    break;
			case 2: // Sub Head for Party
				    $shcode = $this->getDefinedTable(Pswf\PartyTable::class)->getColumn($subheadID, 'code');	
				    break;			    
			case 3: // Sub Head for Bank Accounts
				    $shcode = $this->getDefinedTable(Pswf\BankaccountTable::class)->getColumn($subheadID, 'code');
				    break;
			case 4: // Sub Head for Fund
			      	$shcode = $this->getDefinedTable(Pswf\FundTable::class)->getColumn($subheadID, 'code');
				    break;
			case 5: // Sub Head for Pay Head
				    $shcode = $this->getDefinedTable(Hr\PayheadTable::class)->getColumn($subheadID, 'pay_head');
				    break;
			case 6: // Sub Head for Cash Accounts
				    $shcode = $this->getDefinedTable(Pswf\CashaccountTable::class)->getColumn($subheadID, 'cash_account');
				    break;
			case 7: // Sub Head for Income Head
				    $shcode = $this->getDefinedTable(Pswf\IncomeheadTable::class)->getColumn($subheadID, 'income_head');
				    break;
			case 8: // Sub head for Employee
    ...
    {
        $this->init();
		$journalTable = $this->getDefinedTable(Pswf\JournalTable::class)->getAll();
        ...
        return new ViewModel(array(
            ...
            'paginator'   => $paginator,
			'page'        => $page,
			'voucherObj'  => $this->getDefinedTable(Pswf\VoucherTable::class),
        ));
    }  
     /**
     *  function/action to add Party Role
     ...
     public function addjournalAction()
    {
        ...
        if($this->getRequest()->isPost()){
            ...
            $data = $this->_safedataObj->rteSafe($data);
            $result = $this->getDefinedTable(Pswf\JournalTable::class)->save($data);
            if($result > 0):
            ...
            return $this->redirect()->toRoute('pchartaccount', array('action'=>'journal'));             
        }
       $ViewModel = new ViewModel(array(
	       'vouchers' => $this->getDefinedTable(Pswf\VoucherTable::class)->getAll(),
        ));      
        $ViewModel->setTerminal(True);
        return $ViewModel;            
    }
    ...
    public function editjournalAction()
    {
       $this->init();
        ...
        $ViewModel = new ViewModel(array(
        	'journal' => $this->getDefinedTable(Pswf\JournalTable::class)->get($this->_id),
			'vouchers' => $this->getDefinedTable(Pswf\VoucherTable::class)->getAll(),
        ));             
        $ViewModel->setTerminal(True);
        return $ViewModel;
