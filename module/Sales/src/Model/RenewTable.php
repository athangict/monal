...
class RenewTable extends AbstractTableGateway 
{
	protected $table = 'po_box_renew'; //tablename
	...
	{		
		...
		$select->from($this->table)
		        ->columns(array(
					'id', 'region', 'location', 'postbox_no','renewal_date','renewal_amount','total_amount','status','author','created','modified',
